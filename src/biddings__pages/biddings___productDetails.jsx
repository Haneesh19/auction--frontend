          ...
          <div className=" flex justify-start flex-col gap-3 bg-white shadow-md rounded-none rounded-bl-md rounded-br-md p-3">
            ...
            {single___Post?.isSolded && (
              <div className="p-3 bg-green-300 rounded-md mb-10">
                <h3>
                  This product has been sold to <span className="text-white font-bold">{purchaser?.soldTo?.fullName}</span> at <span className="text-red-400 font-bold">Rs {purchaser?.purchasedAt}</span> {"(10% has been deducted from the bid Amount As Admin charge ) "}
                </h3>
              </div>
            )}
          </div>
